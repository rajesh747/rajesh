...
oc set probe dc/tasks --readiness --get-url=http://:8080/ --initial-delay-seconds=20 --timeout-seconds=20 -n ${GUID}-tasks-dev
oc set probe dc/tasks --liveness --get-url=http://:8080/ --initial-delay-seconds=20 --timeout-seconds=20 -n ${GUID}-tasks-dev
