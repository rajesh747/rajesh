...
oc set probe dc/tasks --readiness --get-url=http://:8080/ --initial-delay-seconds=60 --timeout-seconds=2 --failureThreshold=10 -n ${GUID}-tasks-dev
oc set probe dc/tasks --liveness --get-url=http://:8080/ --initial-delay-seconds=60 --timeout-seconds=2 --failureThreshold=10 -n ${GUID}-tasks-dev
